...
class AppConstants {
  // app constants
  static const String appName = 'Video Stream APP';
  static const String userModelString = 'usermodel';
  static const String avialbleVideosListString = 'avilableVideosList';
  static const String TOKEN = 'token';
  static late UserModel loggedUser;
  ...
  static String jsonData = json.encode(data); // Convert Map to JSON string
  static Map<String, dynamic> jsonMap = json.decode(jsonData);

  // static List<Video> videoDataCollection = [];
}
